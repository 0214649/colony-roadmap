...
const WLEDGER_DATA = {
  ...
  entries: [
    ...
    { w: "w059", date: "2026-07-08", title: "the world gets its body", note: "a week of standing billboard world sprites through the Midjourney→key→crush pipeline: the queen, the maw, the ember-heater incubator, the toolbox, the drive, and every tunnel as an earthen burrow-mound with a per-chamber motif — a tunnel is a folder is a door.", img: "w059" },
    { w: "w060", date: "2026-07-08", title: "the Fear & Hunger palette", note: "coherence as one locked 48-colour desaturated master palette — median-cut from the corpus, transformed to plum-black shadows, bone lights and a dried-gold smoulder, then snapped nearest-colour across the whole catalog. idempotent; it replaces the per-sprite desaturate. 32/48/64 read near-identical, 48 is the lock.", img: "w060" },
  ],
};
