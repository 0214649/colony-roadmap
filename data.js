  ...
  chambers: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Cleaner-AI = ORDER (the cleanup/organize agent; sootheth heals, Order cleans). Two modes = the autonomy dial: MANUAL (you direct, watch ants haul, OS moves it underneath — you're in the loop) vs AUTONOMOUS (ants auto-move once they hold AUTHORITY = max_pheromone, floor scaling with FILE SIZE × progression; authorize auto-clean PER FOLDER). DANGER SURFACE = real file-moves ONLY (nibbles are safe). Ceding to the auto-cleaner = the rim drift made literal. OWED: the cleaning MODEL (what it moves where)", shards: 4 },
