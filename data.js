...
const COLONY_DATA = {
  ...
  chambers: [
    ...
    {
      name: "Cosmology",
      desc: "3 tiers (legibility, not power), and a pantheon reworked into a codex",
      items: [
        { name: "Tier structure — you · concept-powers · two unknowable powers", shards: 18 },
        { name: "Verb-epithet naming — OE 'se þe …aþ' → 'it …eth', two states (comprehension = translation)", shards: 9 },
        ...
        { name: "it interpreteth (was Bridges) — entry finished · nil/nil/nil, the lens you read all through", shards: 10 },
        { name: "it holloweth (Void) — entry finished · husks = shared spawn with Motion", shards: 9 },
        { name: "it yoketh (Obedience) — entry finished · touch = the player (the hidden reveal)", shards: 9 },
        { name: "Conquest — owns shards ▽; domain = all folders", shards: 6 },
        { name: "Plenum — the not-empty pole, opposite of Void (replaces Storage)", shards: 4 },
        { name: "entropy / chaos — the unkillable wall; Void is NOT it", shards: 3 },
        { name: "Authority — sealed deep / OS root; Obedience answers to it (named, unfleshed)", shards: 2 },
        { name: "Genesis / origin", shards: 2 },
        { name: "Motion — the husk's co-owner (parked)", shards: 1 },
      ],
    },
    {
