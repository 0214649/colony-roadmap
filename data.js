  ...
  chambers: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "The hub (placeholder name — SPLITS in proto-008) — mission control. Was doing two jobs; separates into the SURFACE MAP (the app's desktop / Windows-desktop-killer landing + the explore-files ⇄ enter-base junction; portals/meta/storage) and the ANT BASE (the colony's own home: chambers · the visible queen · lineage · processing — not your real folders; candidate root = the game's own bundled folder)", shards: 15 },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Prototype 008 (planned — the base rung; 'hub' retired) — the hub SPLITS into the SURFACE MAP (the app's desktop, the Windows-desktop-killer landing + the explore-files ⇄ enter-base junction) and the ANT BASE (the colony's own home: chambers · the visible queen · lineage · processing — not your real folders; candidate root = the game's own bundled folder). Redistributes the old hub (processing/chambers/queen → base; launchpad/junction/meta → surface). Naming owed", shards: 1 },
