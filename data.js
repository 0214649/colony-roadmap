  ...
  chambers: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Prototype 005 (DONE — the ant-movement skeleton; runs WSLg/Windows) — THE TERRARIUM: desktop icon-grid + ~10 ants + Tab-flip file-tree + the FORAGING LOOP. Right-drag pheromone roads (freehand→straight, line-length cost w/ refund-to-straight, backtrack-to-trim, one-road-max, ⌇ budget cap, auto-tap crossed folders as branch-offs/no-bending, CROSSING roads connect at a junction, FLOATING roads self-erase). Ant logistics: congestion-aware Dijkstra reroute, queue/max-flow (spacing+lanes+per-folder caps), no-teleport (walk-in + hub-rebalance), animated turns/U-turns, smooth road-insertion, carry-home delivery. Visual: glyphs-on-ground / names-on-top, number-pop animations, chomp-the-border gait. Hardened (main can't orphan window). Open: SMART-CROSSROAD system (cluster nearby junctions into clean symmetric/curvy intersections, SimCity-style); real-file moves+haul; in-app behavior menu; active sidestepping; skin", shards: 8 },
