  ...
  chambers: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "heft — the construction unit (LOCKED): a measure of MASS (build-side counterpart to sate). ONE unit underneath, surfacing as 8 TYPES across 4 BANDS on the organic→synthetic gradient (material = morality): ORGANIC chitin◗·fiber∥ | EARTHEN clay◣·ash∷ | MINERAL stone▲·gem✦ | SYNTHETIC alloy◈·plastic▤. Binders (honey⬡ + resin/silk/mud/sap) join heft, not a heft type. WHY 8 = ambient-variety dopamine (always something to watch) + co-op hauls (many ants drag a big insect home together), NOT optimizer busywork; each type must read instantly when carried. Glyphs placeholder (art-pass owed)", shards: 6 },
