  ...
  chambers: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "SCORE + TYPE unit class — food & construction materials run one engine; every item carries a SCORE (how much) + a TYPE (what); recipes gate on both (sandstone ≠ plain stone); ~3 construction types TBD", shards: 3 },
        ...
        { name: "FOOD (placeholder, seeded) — shared multi-god nourishment-weighted unit; per-creature diets + food-types; forgiving small / binding large; census Σ raises the ceiling, food gates filling it. Player-tier triad: shards ▽ · pheromone ⌇ · census Σ = space · control · scale", shards: 1 },
